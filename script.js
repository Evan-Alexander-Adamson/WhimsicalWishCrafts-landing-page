document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initial text fade out after 2 seconds
    setTimeout(() => {
    ...
    async function updateBackground(isInitialLoad = false) {
        ...
        if (currentIndex === 0) {
            ...
            heroBackground.style.backgroundColor = 'var(--light-bg)';
        } else {
            // For other slides, use the corresponding photo
        ...
        setTimeout(() => {
            heroBackground.style.opacity = '0.75';
